# -*- coding: utf-8 -*-
"""
ItWorksOnYourMachineToo Dependency Manager - Gestionnaire de dépendances
====================================================
...
class DependencyManager:
    """Gestionnaire de dépendances pour ItWorksOnYourMachineToo avec isolation et résolution de conflits."""

    def __init__(self, project_path: str):
        """Initialise le gestionnaire de dépendances."""
        self.project_path = validate_and_sanitize_path(project_path)
        self.logger = get_logger()
        self.venv_path = Path(self.project_path) / ".itworks" / "venv"
        self.deps_cache_path = Path(self.project_path) / ".itworks" / "deps_cache.json"
    ...
    def create_isolated_environment(self) -> bool:
        ...
        try:
            ...
            # Créer le répertoire .itworks s'il n'existe pas
            iwym_dir = Path(self.project_path) / ".itworks"
            iwym_dir.mkdir(parents=True, exist_ok=True)
